...
1. remove first type:'street' results if there are other non-street / addresses close by = http://localhost:45554/pelias?text=45.5,-122.5 == a street polyline is first response
