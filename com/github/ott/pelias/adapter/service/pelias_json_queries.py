...
def neighborhood_fix(
    neighborhood, def_val=None, ban_list=["Portland International Airport"]
):
...
def find_feature_property(
    pelias_response, property_name, feature_index=0, def_val=None
):
    ret_val = def_val
    try:
